...
//used method
	...
	public void Log_Pass(String stepName, String passMessage)
	{
		getTestReporter().log(LogStatus.PASS, stepName, passMessage);
		
	}

	public void Log_Fail(String stepName, String failMessage) throws InterruptedException
	{
		getTestReporter().log(LogStatus.FAIL, stepName, failMessage);
//		String img = reporter.addScreenCapture(Common_Functions.captureScreenshot(driver,snapshotsPath));
//		testReporter.log(LogStatus.INFO, stepName, "Error Snap: " + img);
	}
	
	public void Log_Fail(String stepName, String failMessage,WebDriver driver,String snapshotsPath) throws InterruptedException
	{
		getTestReporter().log(LogStatus.FAIL, stepName, failMessage);
		String img = getTestReporter().addScreenCapture(Common_Functions.captureScreenshot(driver,snapshotsPath));
		getTestReporter().log(LogStatus.INFO, stepName, "Error Snap: " + img);
	}	
	...
	public  void Log_Pass_with_Screenshot(String stepName, String passMessage, WebDriver driver,String snapshotsPath) throws InterruptedException
	{
		...
		Thread.sleep(5000);
		String img = getTestReporter().addScreenCapture(Common_Functions.captureScreenshot(driver,snapshotsPath));
		getTestReporter().log(LogStatus.INFO, stepName, "Success Snap: " + img);			
	}
	...
	{
		getTestReporter().log(LogStatus.FAIL, stepName, passMessage);
		Thread.sleep(5000);
		String img = getTestReporter().addScreenCapture(Common_Functions.captureScreenshot(driver,snapshotsPath));
		getTestReporter().log(LogStatus.INFO, stepName, "Success Snap: " + img);
	}	
