...
public class TestPcloudyChrome {
...
//		capabilities.setCapability("pCloudy_DeviceManafacturer", "Oneplus_6T_Android_9.0.0");
		capabilities.setCapability("pCloudy_DeviceVersion", "9.0.0");
		capabilities.setCapability("pCloudy_DeviceFullName", "Oneplus_6T_Android_9.0.0");
...
//	      driver.manage().window().setSize(new Dimension(1792, 1017));
	      driver.findElement(By.xpath("//a[@id='mobile-menu']/span")).click();
...
//	      driver.findElement(By.cssSelector(".menu-open")).click();
	      driver.findElement(By.cssSelector(".dl-menu > .menu-item-home span")).click();
		}
